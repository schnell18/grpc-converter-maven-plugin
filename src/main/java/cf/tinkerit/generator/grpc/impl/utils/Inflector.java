...
/**
 * Transforms words to singular, plural, humanized (human readable),
 * underscore, camel case, or ordinal form. This is inspired by the <a
...
public class Inflector {
     ...
     * uppercased, or false if the first character is to be lowercased
     * @param delimiterChars optional characters that are used to delimit word boundaries
     ...
     * boundaries (beyond capitalization) @return a lower-cased version of the
     * input, with separate words delimited by the underscore character.
     */
     ...
     * @return the string with the first character capitalized and the
     ...
     * trailing "_id" and any supplied removable tokens.  Like {@link
     ...
     * {@link #pluralize(Object) pluralize} and

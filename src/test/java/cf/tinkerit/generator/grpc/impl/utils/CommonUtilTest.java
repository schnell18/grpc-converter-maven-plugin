...
import static cf.tinkerit.generator.grpc.impl.utils.CommonUtil.wrapFootnote;
...
public class CommonUtilTest {
    ...
    public void wrapFootnoteMatchedEnglishComma() {
        String str = "显示模板编码,  参考:http://doc.pajk-ent.com/pages/viewpage.action?pageId=40935212";
        String exp = "显示模板编码\\footnote{参考:http://doc.pajk-ent.com/pages/viewpage.action?pageId=40935212}";
